...
namespace MyOnlineClinic.Web.Areas.Organizations.Controllers
{
    public class VoucherController : BaseController
    {
        ...
        public VoucherController(IVoucherService voucherservice, IDoctorService doctorService, IUserService userservice, IOrganizationService organizationservice)
        {
        ...
        public ActionResult VoucherAssign()
        {
            ...
            var Vouchermodel = _voucherService.GetVoucherList().Select(x => new VoucherViewModel
                                    {
